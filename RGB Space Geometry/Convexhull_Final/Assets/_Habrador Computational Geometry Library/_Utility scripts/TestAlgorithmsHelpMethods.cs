...
public static class TestAlgorithmsHelpMethods
{
    ...
    public static HashSet<MyVector3> GenerateMyRandomPoints3D(int seed, float halfCubeSize, int numberOfPoints)
    {
        HashSet<MyVector3> randomPoints = new HashSet<MyVector3>();
        ...
        for (int i = 0; i < numberOfPoints; i++)
        {
            ...
            randomPoints.Add(new MyVector3(randomX, randomY, randomZ));
        }
